...
public class GamePanel extends JPanel implements ActionListener, KeyListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		//if snake touch boundry and game noover
...
//		if (snakeylength[0] < 75)snakeylength[0] = 625;
		...
		//check boundry collison
		else if (snakexlength[0] < 25 || snakexlength[0] > 850 || snakeylength[0] < 75 || snakeylength[0] > 625) {
		        gameOver = true;
		        timer.stop();
		    }
